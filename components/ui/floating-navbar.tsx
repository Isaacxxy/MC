...
export const FloatingNav = ({
  ...
  if (pathname === "/payment-success" || pathname.startsWith("/library/"))
    return;
  return (
    <div
      className={`${
        scrollPosition === 0
          ...
          : `z-[500] fixed top-0 w-full border-b backdrop-blur-sm ${
              pathname === "/"
    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <h1
            className={`hidden sm:flex items-center justify-center space-x-2 text-2xl font-bold py-4 text-center mr-10 ${
              playfair.className
            } ${
              pathname === "/"
