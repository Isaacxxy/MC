            ...
            {isWalletEmpty ? (
              <div className="flex flex-col items-center justify-between flex-1">
                <div className="flex items-center justify-center w-full flex-1">
                  <p className="text-gray-500 text-lg font-medium bg-white dark:bg-black p-6 rounded-full">Your wallet is empty</p>
                </div>
                <button
                  onClick={() => {
                ...
                >
                  <span className="w-5 h-5"><IoIosPricetags className="w-5 h-5" /></span>
                  Buy a Coupons
                </button>
              </div>
            ) : (
